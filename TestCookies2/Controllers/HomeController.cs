...
namespace TestCookies2.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult ChangeUnit(string Unit) // identifying unit and passing along with the link itself
        {
            // 1. Get the data
            ...
            return RedirectToAction("Index"); //not returning view, redirects to Index; attaching to the http response 
